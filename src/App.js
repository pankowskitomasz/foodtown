...
import OfferDetailsView from './views/offer/offerDetailsView';
  ...
  return (
    <Router>
        <Routes>
            ...
            <Route exact path="/offer" element={<OfferView/>}/>
            <Route exact path="/offer/details/*">
              <Route path=":id"  element={<OfferDetailsView/>}/>
            </Route>
            <Route exact path="/offer/list" element={<OfferListView/>}/>
